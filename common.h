...
#define TEXTIN "textin.raw"
#define TEXTOUT "textout.raw"
#define TRACES "traces.raw"
#define KEY "key.raw"
...
float_f compute_correlation_coeff(float_f t0[256], float_f t1[256]);
float_f compute_correlation_coeff_non_null(float_t t0[256], float_t t1[256]);
